...
# Deploy Web app
# #>
# $bicepTemplateFile = Join-Path -Path $PSScriptRoot -ChildPath "templates/webapp.arm.template.json"
# $armParameterFile = Join-Path -Path $PSScriptRoot -ChildPath "templates/webapp.arm.parameters.json"
# Write-Host "Going to create a web app using ARM template $bicepTemplateFile"
...
# az webapp up --name "sau00123" --timeout 180000
# Pop-Location
